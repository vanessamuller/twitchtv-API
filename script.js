      ...
      if(res.stream===null){
        ...
        $.getJSON("https://wind-bow.gomix.me/twitch-api/channels/"+name,function(rest){
          if(rest.error){
            ...
            $("#followerInfo").prepend("<div class='row line'>"+ '<div class="col-md-4 sta ">'+ "<img class='img-responsive' src='http://i0.kym-cdn.com/profiles/icons/big/000/071/040/404%20is%20not%20found.jpg' >"+ "</div>" + '<div class="col-md-4 sta text-center">'+ name + '</div>' +'<div class="col-md-4 sta text-center">' + status3 +'</div> </div>');
          }
          else{
            var logo2= rest.logo;
